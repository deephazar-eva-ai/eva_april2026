...
class DesktopOutput(BaseModel):
    """Typed payload the Desktop agent writes into AgentResult.output.
    
    `path` is the cascade layer the skill used.
    """
    path: Literal["act", "escalate", "a11y", "vision"]
    verdict: Literal["act", "escalate"] | None = None
