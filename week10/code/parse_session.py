...
session_dir = Path("/home/acer/Documents/DEEPAK/eva_april2026/mainbranch/eva_april2026/week9/code/state/sessions/s8-22cdb9d6")
...
for nid in sorted(nodes.keys(), key=lambda x: int(x.split(":")[1])):
    ...
    print(f"  Cost: {n['result']['cost']}, Elapsed: {n['result']['elapsed_s']}s")
