...
{"rationale": "Fetch each city's population in parallel using the browser, then compare.",
 "nodes": [
   {"skill":"browser","inputs":[],
    "metadata":{"label":"bL","url":"https://html.duckduckgo.com/html/?q=current+population+of+London","goal":"extract current population of London"}},
   {"skill":"browser","inputs":[],
    "metadata":{"label":"bP","url":"https://html.duckduckgo.com/html/?q=current+population+of+Paris","goal":"extract current population of Paris"}},
   {"skill":"browser","inputs":[],
    "metadata":{"label":"bB","url":"https://html.duckduckgo.com/html/?q=current+population+of+Berlin","goal":"extract current population of Berlin"}},
   {"skill":"formatter","inputs":["USER_QUERY","n:bL","n:bP","n:bB"],
    "metadata":{"label":"out"}}]}
